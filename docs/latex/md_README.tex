...
Quite usable, but not fully fleshed out yet.\hypertarget{md_README_autotoc_md2}{}\doxysection{\texorpdfstring{Before you start}{Before you start}}\label{md_README_autotoc_md2}
...
The utilities/ directory contains utility programs, which are compiled using the make utilities -\/B command.\hypertarget{md_README_autotoc_md11}{}\doxysection{\texorpdfstring{Supported metrics and analysis}{Supported metrics and analysis}}\label{md_README_autotoc_md11}
