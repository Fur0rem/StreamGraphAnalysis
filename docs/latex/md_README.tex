...
Quite usable, but not fully fleshed out yet. If you do end up using it, please let me know, I would be happy to hear your feedback and suggestions. Also it\textquotesingle{}d be appreciated if you linked to the project in your paper or project if you use it.\hypertarget{md_README_autotoc_md2}{}\doxysection{\texorpdfstring{Before you start}{Before you start}}\label{md_README_autotoc_md2}
