...
There are some example data files in the data/ directory.\hypertarget{index_autotoc_md7}{}\doxysection{\texorpdfstring{What it can do}{What it can do}}\label{index_autotoc_md7}
...
The data/ directory contains example data files.\hypertarget{index_autotoc_md11}{}\doxysection{\texorpdfstring{Supported metrics and analysis}{Supported metrics and analysis}}\label{index_autotoc_md11}
